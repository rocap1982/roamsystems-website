...
import { vehicles, heroImage } from './homeData';
    ...
    <section id="top" className="relative flex min-h-screen items-center overflow-hidden pt-28 md:pt-32">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 md:px-8">
        ...
        >
          <a
            href="/products"
            className="group inline-flex items-center gap-3 rounded-md bg-[color:var(--color-amber-base)] px-8 py-4 text-sm font-black uppercase tracking-wider text-black transition-all hover:bg-[color:var(--color-amber-bright)] hover:shadow-[0_0_40px_rgba(232,126,4,0.35)]"
          >
            Shop Now
