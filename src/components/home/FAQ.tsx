...
const faqs = [
  ...
  { q: 'How long does delivery take?', a: 'Build lead time is typically 2–4 weeks depending on spec and current demand. UK delivery is 3–5 working days from dispatch.' },
