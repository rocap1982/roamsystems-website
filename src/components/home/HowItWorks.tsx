...
const steps = [
  { num: '01', title: 'Browse & Choose', desc: 'Explore the range. Spec your build. Add to basket.', Icon: Search },
  { num: '02', title: 'Send Enquiry', desc: 'Submit your basket with vehicle and fitment details.', Icon: Send },
  { num: '03', title: 'We Call You', desc: 'Direct line to the workshop. Confirm and schedule.', Icon: PhoneCall },
  { num: '04', title: 'Built & Delivered', desc: 'Precision-built to order. Delivered UK-wide.', Icon: Truck },
];
      ...
      <div className="relative mx-auto max-w-7xl px-4 md:px-8">
        ...
        >
          <div className="inline-flex items-center gap-3">
            ...
            <span className="text-xs font-black uppercase tracking-[0.2em] text-[color:var(--color-amber-base)]">The Process</span>
            <span className="h-px w-10 bg-[color:var(--color-amber-base)]" />
          </div>
          ...
          <div className="grid gap-12 md:grid-cols-4 md:gap-6">
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  <div className="relative z-10 flex h-24 w-24 shrink-0 items-center justify-center rounded-lg border border-[color:var(--color-ink-600)] bg-[color:var(--color-ink-800)]">
                  ...
                  <div className="flex-1 pt-1 md:pt-4">
                    <h3 className="font-black uppercase tracking-tight text-white text-xl">{step.title}</h3>
                    <p className="mt-2 text-sm text-[color:var(--color-ink-300)]">{step.desc}</p>
                  </div>
                </motion.div>
              );
            })}
