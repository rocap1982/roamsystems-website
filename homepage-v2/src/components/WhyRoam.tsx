...
const features = [
  ...
  },
  {
    ...
    body: 'Laser-cut frames. CNC-machined joinery. Powder-coated finishes. Built to tolerances the caravan industry has never seen.',
    meta: '±0.2mm tolerance',
  },
  {
    Icon: MapPin,
    title: 'Designed & Made in the UK',
    body: 'Manufactured by Romark Engineering Ltd in Essex. Protected by EU Registered Community Design RCD 015033319.',
    meta: 'RCD 015033319',
  },
  {
    Icon: Users,
    title: 'Nationwide Support',
    body: 'A network of 17 approved installers from Essex to Scotland. Fit it yourself, or let a pro handle it.',
    meta: '17 Installers',
  },
];
...
export function WhyRoam() {
  return (
    <section id="vehicles" className="relative bg-[color:var(--color-ink-800)] py-24 md:py-32">
              ...
              >
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-[color:var(--color-ink-300)]">
                      {f.body}
                    </p>
                  </div>
                </div>
