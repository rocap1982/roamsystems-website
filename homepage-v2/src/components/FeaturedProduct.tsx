        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-2xl border border-[color:var(--color-ink-600)] bg-[color:var(--color-ink-800)]">
              <img
                ...
                loading="lazy"
              />
              {/* Dark tint for overlays to stay readable */}
            ...
            <motion.div
              ...
              className="absolute -right-4 -top-4 rounded-lg border border-[color:var(--color-amber-base)] bg-[color:var(--color-ink-900)] px-5 py-4 shadow-[0_0_40px_var(--color-amber-glow)] md:-right-8 md:-top-8"
            >
          ...
          <div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-3">
              {featuredProduct.specs.map((spec, i) => (
                ...
                >
                  ...
                  <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-[color:var(--color-ink-300)]">
                    {spec.label}
                  </div>
            ...
            <motion.a
              ...
              className="group mt-10 inline-flex items-center gap-3 rounded-md border border-[color:var(--color-ink-500)] bg-[color:var(--color-ink-800)] px-8 py-4 text-sm font-black uppercase tracking-wider text-white transition-all hover:border-[color:var(--color-amber-base)] hover:bg-[color:var(--color-ink-700)]"
            >
              View Full Details
